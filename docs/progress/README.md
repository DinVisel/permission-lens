...
| 2 — Registry v0 and on-chain enrichment | 🟡 in progress (enrichment, new rules, CLI criterion, and `tools/census` v0 done; running census against real chain history and a second-maintainer review of the seeded registry entries outstanding) | [phase-2-registry-onchain.md](phase-2-registry-onchain.md) |
